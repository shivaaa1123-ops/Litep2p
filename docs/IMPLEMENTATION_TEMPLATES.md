...
> **Scope:** this document is **engine-internal engineering material** — copy-paste
> starting templates for C++ reliability improvements inside `litep2p-core/src/main/cpp`.
> It is **not** part of the public SDK surface. For the API reference that SDK
> consumers (e.g. your chat application layer) should use, see
